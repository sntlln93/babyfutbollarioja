...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12 col-md-8 mx-auto">
            <form action="{{ route('clubs.update', ['club' => $club->id]) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('put')
                ...
                <div class="form-row mb-2">
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control @error('name') border-danger @enderror" id="name"
                            name="name" value="{{ $club->name }}" value="{{ old('name') }}" required>
                ...
                <div class="form-row mb-2">
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control @error('field_description') border-danger @enderror"
                            id="field_description" name="field_description" value="{{ $club->field_description }}"
